...
export default function App() {
  ...
  const [rawPreview, setRawPreview] = useState([]); // prévia da planilha original
  ...
  function processData(rows) {
    ...
    // guarda preview das primeiras 5 linhas
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 text-white">
      ...
      <main className="mx-auto max-w-6xl px-6 py-12 space-y-12">
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <div className="rounded-xl border border-gray-700 bg-gray-800/60 p-6">
                ...
                {report.linhasDeletadas.length > 0 && (
                  <div className="mb-6">
                    <button
        ...
        {/* ====== Seção 2: Conversor XLSX → CSV (vírgula) ====== */}
        <section className={sectionCard}>
          <Conversor />
        </section>
      ...
      <footer className="text-center text-gray-300 py-8 border-t border-gray-800">
        <p className="text-sm">
          Desenvolvido por Mickael Maciel
        </p>
      </footer>
    </div>
  );
